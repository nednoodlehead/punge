...
pub fn update_playlist(old_title: &str, new_title: &str, description: &str, image: &str) -> Result<(), DatabaseErrors> {
...
pub fn update_song(author: &str, title: &str, album: &str, features: &str, unique: &str) -> Result<(), DatabaseErrors> {
...
pub fn quick_swap_title_author(author: &str, title: &str, uniqueid: &str) -> Result<(), DatabaseErrors> {
    let conn: Connection = rusqlite::Connection::open("main.db")?;
